...
<figure class="figure">
  <img
    src="spurn-head-curve.png"
    class="figure-img img-fluid rounded"
    alt="The walk isn't circular, but at least it's got a nice curve to it."/>
  <figcaption class="figure-caption text-center">
...
<figure class="figure">
  <img
    src="wader-roost-i.png"
    class="figure-img img-fluid rounded"
    alt="Secret bird pact evidence file #1."/>
  <figcaption class="figure-caption text-center">
...
<figure class="figure">
  <img
    src="wader-roost-ii.png"
    class="figure-img img-fluid rounded"
    alt="Secret bird pact evidence file #2."/>
  <figcaption class="figure-caption text-center">
...
<figure class="figure">
  <img
    src="migrant-hawker-maybe.png"
    class="figure-img img-fluid rounded"
    alt="Is this a very confiding Migrant Hawker? We think it is."/>
  <figcaption class="figure-caption text-center">
...
<figure class="figure">
  <img
    src="kilnsea-wetlands.png"
    class="figure-img img-fluid rounded"
    alt="Kilnsea Wetlands"/>
  <figcaption class="figure-caption text-center">
    Kilnsea Wetlands
  </figcaption>
</figure>
